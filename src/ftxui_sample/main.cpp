...
// configuration step. It creates a namespace called `cppcmake`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cppcmake::cmake::project_name, cppcmake::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cppcmake::cmake::project_version);
      return EXIT_SUCCESS;
    }
